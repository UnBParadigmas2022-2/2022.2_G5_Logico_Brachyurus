...
| Christian Fleury Alencar Siqueira | 1. Funcionalidades adicionadas: -[Adição do nó 19] <br> -[Adição do nó 20] <br> -[Adição do nó 21] <br> -[Adição da estrutura incial do menu] (colaboração com a Leticia) <br> -[Adição do tutorial] <br> 2. Funcionalidades revisadas: - [Dificuldade] (https://github.com/UnBParadigmas2022-2/2022.2_G5_Logico_Brachyurus/pull/5)| Excelente |
